"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.AssistantMessageComponent = void 0;
      ...
      if (content.type === "text" && content.text.trim()) {
        ...
        if (this.hideThinkingBlock) {
          ...
          this.contentContainer.addChild(
            new _piTui.Text(_theme.theme.italic(_theme.theme.fg("thinkingText", this.hiddenThinkingLabel)), 1, 0)
          );
          ...
          this.contentContainer.addChild(
            new _piTui.Markdown(content.thinking.trim(), 1, 0, this.markdownTheme, {
...
}exports.AssistantMessageComponent = AssistantMessageComponent; /* v9-c4138a0d4607e023 */
