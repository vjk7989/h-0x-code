"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.SettingsManager = exports.InMemorySettingsStorage = exports.FileSettingsStorage = void 0;
...
var _httpDispatcher = await jitiImport("./http-dispatcher.ts");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function parseTimeoutSetting(value, settingName) {
  const timeoutMs = (0, _httpDispatcher.parseHttpIdleTimeoutMs)(value);
...
class FileSettingsStorage {
  ...
  constructor(cwd, agentDir) {
    ...
    this.globalSettingsPath = (0, _path.join)(resolvedAgentDir, "settings.json");
    this.projectSettingsPath = (0, _path.join)(resolvedCwd, _config.CONFIG_DIR_NAME, "settings.json");
  }
...
class SettingsManager {
  ...
  getSessionDir() {
    ...
    return sessionDir ? (0, _paths.normalizePath)(sessionDir) : sessionDir;
  }
  ...
  getHttpIdleTimeoutMs() {
    return parseTimeoutSetting(this.settings.httpIdleTimeoutMs, "httpIdleTimeoutMs") ?? _httpDispatcher.DEFAULT_HTTP_IDLE_TIMEOUT_MS;
  }
  ...
  setEnableAnalytics(enabled) {
    ...
    if (enabled && !this.globalSettings.trackingId) {
      this.globalSettings.trackingId = (0, _crypto.randomUUID)();
...
}exports.SettingsManager = SettingsManager; /* v9-2b54742380c6dc2f */
