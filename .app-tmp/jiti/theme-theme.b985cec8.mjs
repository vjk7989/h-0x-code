"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.Theme = void 0;exports.detectTerminalBackgroundFromEnv = detectTerminalBackgroundFromEnv;exports.detectTerminalBackgroundTheme = detectTerminalBackgroundTheme;exports.getAvailableThemes = getAvailableThemes;exports.getAvailableThemesWithPaths = getAvailableThemesWithPaths;exports.getDefaultTheme = getDefaultTheme;exports.getEditorTheme = getEditorTheme;exports.getLanguageFromPath = getLanguageFromPath;exports.getMarkdownTheme = getMarkdownTheme;exports.getResolvedThemeColors = getResolvedThemeColors;exports.getSelectListTheme = getSelectListTheme;exports.getSettingsListTheme = getSettingsListTheme;exports.getThemeByName = getThemeByName;exports.getThemeExportColors = getThemeExportColors;exports.getThemeForRgbColor = getThemeForRgbColor;exports.highlightCode = highlightCode;exports.initTheme = initTheme;exports.isLightTheme = isLightTheme;exports.loadThemeFromPath = loadThemeFromPath;exports.onThemeChange = onThemeChange;exports.setRegisteredThemes = setRegisteredThemes;exports.setTheme = setTheme;exports.setThemeInstance = setThemeInstance;exports.stopThemeWatcher = stopThemeWatcher;exports.theme = void 0;var fs = _interopRequireWildcard(await jitiImport("node:fs"));
...
var _syntaxHighlight = await jitiImport("../../../utils/syntax-highlight.ts");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
function createTheme(themeJson, mode, sourcePath) {
  const colorMode = mode ?? ((0, _piTui.getCapabilities)().trueColor ? "truecolor" : "256color");
...
function startThemeWatcher() {
  ...
  themeWatcher =
  (0, _fsWatch.watchWithErrorHandler)(
    customThemesDir,
    (_eventType, filename) => {
      if (currentThemeName !== watchedThemeName) {
        return;
...
function highlightCode(code, lang) {
  ...
  const validLang = lang && (0, _syntaxHighlight.supportsLanguage)(lang) ? lang : undefined;
  ...
  try {
    return (0, _syntaxHighlight.highlight)(code, opts).split("\n");
  } catch {
    return code.split("\n");
  }
}
