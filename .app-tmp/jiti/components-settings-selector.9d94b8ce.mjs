"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.SettingsSelectorComponent = void 0;
...
const DEFAULT_PROJECT_TRUST_BY_LABEL = new Map(
  Object.entries(DEFAULT_PROJECT_TRUST_LABELS).map(([value, label]) => [label, value])
);
...
class WarningSettingsSubmenu extends _piTui.Container {
  ...
  constructor(warnings, onChange, onCancel) {
    ...
    this.settingsList = new _piTui.SettingsList(
      items,
      Math.min(items.length, 10),
      (0, _theme.getSettingsListTheme)(),
      (id, newValue) => {
        switch (id) {
...
class SettingsSelectorComponent extends _piTui.Container {
  ...
  constructor(config, callbacks) {
    ...
    const followUpKey = (0, _keybindingHints.keyDisplayText)("app.message.followUp");
    ...
    },
    {
      ...
      currentValue: (0, _httpDispatcher.formatHttpIdleTimeoutMs)(config.httpIdleTimeoutMs),
      values: _httpDispatcher.HTTP_IDLE_TIMEOUT_CHOICES.map((choice) => choice.label)
    },
    {
      id: "hide-thinking",
      label: "Hide thinking",
      ...
      (id, newValue) => {
        switch (id) {
          ...
          case "http-idle-timeout":{
              const choice = _httpDispatcher.HTTP_IDLE_TIMEOUT_CHOICES.find((item) => item.label === newValue);
              if (choice) {
...
}exports.SettingsSelectorComponent = SettingsSelectorComponent; /* v9-8ddfa17da279cc33 */
