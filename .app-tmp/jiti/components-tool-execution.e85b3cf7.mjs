"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ToolExecutionComponent = void 0;var _piTui = await jitiImport("@earendil-works/pi-tui");

var _index = await jitiImport("../../../core/tools/index.ts");
var _renderUtils = await jitiImport("../../../core/tools/render-utils.ts");
    ...
    if (this.result) {
      ...
      for (let i = 0; i < imageBlocks.length; i++) {
        ...
        if (caps.images && this.showImages && img.data && img.mimeType) {
          ...
          const imageComponent = new _piTui.Image(
            imageData,
            imageMimeType,
            { fallbackColor: (s) => _theme.theme.fg("toolOutput", s) },
...
}exports.ToolExecutionComponent = ToolExecutionComponent; /* v9-04f57f80d620e875 */
