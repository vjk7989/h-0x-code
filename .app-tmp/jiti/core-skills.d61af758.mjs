"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.formatSkillsForPrompt = formatSkillsForPrompt;exports.loadSkills = loadSkills;exports.loadSkillsFromDir = loadSkillsFromDir;var _fs = await jitiImport("fs");
...
function addIgnoreRules(ig, dir, rootDir) {
  ...
  for (const filename of IGNORE_FILE_NAMES) {
    ...
    if (!(0, _fs.existsSync)(ignorePath)) continue;
    try {
...
function loadSkills(options) {
  ...
  const resolvedAgentDir = (0, _paths.resolvePath)(agentDir ?? (0, _config.getAgentDir)());
  ...
  if (includeDefaults) {
    ...
    addSkills(loadSkillsFromDirInternal((0, _path.resolve)(resolvedCwd, _config.CONFIG_DIR_NAME, "skills"), "project", true));
  }

  const userSkillsDir = (0, _path.join)(resolvedAgentDir, "skills");
  const projectSkillsDir = (0, _path.resolve)(resolvedCwd, _config.CONFIG_DIR_NAME, "skills");
