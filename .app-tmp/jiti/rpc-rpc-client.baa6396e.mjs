...
var _jsonl = await jitiImport("./jsonl.ts"); /**
...
class RpcClient {
  ...
  async start() {
    ...
    const childProcess = (0, _nodeChild_process.spawn)("node", [cliPath, ...args], {
    ...
    this.stopReadingStdout = (0, _jsonl.attachJsonlLineReader)(childProcess.stdout, (line) => {
  ...
  async send(command) {
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        stdin.write((0, _jsonl.serializeJsonLine)(fullCommand));
      } catch (error) {
...
}exports.RpcClient = RpcClient; /* v9-1a6c0d76465a0395 */
