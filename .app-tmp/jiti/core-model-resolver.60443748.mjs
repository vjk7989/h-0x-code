...
var _defaults = await jitiImport("./defaults.ts");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };} /**
 * Model resolution, scoping, and initial selection
 */
/** Default model IDs for each known provider */
const defaultModelPerProvider = exports.defaultModelPerProvider = {
  ...
  if (model) {
    ...
    if (inferredProvider) {
      const rawExactMatches = availableModels.filter(
        (m) => m.id.toLowerCase() === cliModel.toLowerCase() && !(0, _piAi.modelsAreEqual)(m, model)
      );
 ...
 */
async function restoreModelFromSession(
savedProvider,
savedModelId,
currentModel,
shouldPrintMessages,
